...
const file = new staticServe.Server(path.join(__dirname, "../../pages/"), {
  cache: 1,
}); // TODO (la final): De facut caching-time mai mare (ex: 3600 == 1 ora)
...
const routing = async (request, response) => {
  ...
  if (
    ...
    if (cookies.authToken != null) {
      var userModel;
      userController
        .getUserModelByToken(cookies.authToken, request, response)
  ...
  if (request.method == "DELETE") {
    ...
    if (url.startsWith("/profile/delete_gamification_system")) {
      if (cookies.authToken != null) {
        return gamificationSystemController.handleDeleteGamificationSystemRequest(
          request,
          response
        );
      }
    ...
    if (url.startsWith("/external/gamification_system")) {
      return gamificationSystemExternalController.handleExternalGamificationSystemDELETERequest(
        request,
        response
      );
    }
  ...
  if (request.method == "PUT") {
    ...
    if (url.startsWith("/profile/modify_gamification_system")) {
      if (cookies.authToken != null) {
        return gamificationSystemController.handleModifyGamificationSystemRequest(
          request,
          response
        );
      }
    ...
    if (url.startsWith("/external/gamification_system")) {
      return gamificationSystemExternalController.handleExternalGamificationSystemPOSTPUTRequest(
        request,
        response
      );
    }
    ...
    request.errorMessage =
      'Nu poți face un request de tip PUT la pagina "' + url + '"!';
    response.setHeader("Location", "/error");
    return errorRoute(request, response);
  }
  ...
  if (request.method == "POST") {
    switch (url) {
      ...
      case "/login": {
        if (cookies.authToken == null) {
          await requestsLimiterController.loginRequestsLimiterFunction(
            request,
            response,
      ...
      case "/register": {
        if (cookies.authToken == null) {
          await requestsLimiterController.registerRequestsLimiterFunction(
            request,
            response,
            function (request, response) {
      ...
      case "/profile/create_gamification_system": {
        if (cookies.authToken != null) {
          return gamificationSystemController.handleCreateGamificationSystemRequest(
            request,
            response
          );
        }
      ...
      case "/admin/users/add": {
        if (cookies.authToken != null) {
          await userController
            .isUserAdmin(cookies.authToken, request, response)
            .then(function (result) {
      ...
      case "/admin/users/import": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return dataController.handleImportUsersRequest(
                  request,
                  response
                );
              else {
      ...
      case "/admin/contact/import": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return dataController.handleImportContactMessagesRequest(
                  request,
                  response
                );
              else {
      ...
      case "/admin/gamification-events/import": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return dataController.handleImportGamificationEventsRequest(
                  request,
                  response
                );
              else {
      ...
      case "/admin/contact/add": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return contactMessageController.adminAddContactPOSTRequest(
                  request,
                  response
                );
              else {
      ...
      case "/admin/gamification-systems/import": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return dataController.handleImportGamificationSystemsRequest(
                  request,
                  response
                );
              else {
      ...
      case "/admin/gamification-rewards/import": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return dataController.handleImportGamificationRewardsRequest(
                  request,
                  response
                );
              else {
      ...
      default: {
        ...
        request.statusCodeMessage = "Forbidden";
        request.errorMessage =
          'Nu poți face un request de tip POST la pagina "' + url + '"!';
        response.setHeader("Location", "/error");
        return errorRoute(request, response);
      }
    }
  ...
  if (request.method === "GET")
    switch (url) {
      ...
      case "/admin/gamification-systems": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminGamificationSystemsRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/gamification-systems/export": {
        if (cookies.authToken != null) {
          ...
          if (isAdmin == -1) {
            ...
            request.errorMessage =
              "A apărut o eroare pe parcursul procesării cererii tale! Încearcă din nou mai târziu, iar dacă problema " +
          ...
          return dataController.handleGamificationSystemsExport(
            request,
            response
          );
        }
      ...
      case "/admin/gamification-rewards": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminGamificationRewardsRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/gamification-rewards/export": {
        if (cookies.authToken != null) {
          ...
          return dataController.handleExportGamificationRewardsRequest(
            request,
            response
          );
        }
      ...
      case "/admin/contact/export": {
        if (cookies.authToken != null) {
          ...
          return dataController.handleContactMessagesExportRequest(
            request,
            response
          );
        }
        ...
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              console.log(result);
              if (result)
                return adminGamificationEventsRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/user-data/export": {
        if (cookies.authToken != null) {
          ...
          return dataController.handleExportGamificationUserDataRequest(
            request,
            response
          );
        }
      ...
      case "/admin/contact": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminGamificationContactRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/gamification-systems/add": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminAddGamificationSystemRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/gamification-rewards/add": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminAddGamificationRewardRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/gamification-events/add": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminAddGamificationEventRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/contact/add": {
        if (cookies.authToken != null) {
          await userController
            ...
            .then(function (result) {
              if (result)
                return adminAddGamificationContactRoute(request, response);
              else {
                // Utilizatorul nu are privilegii de administrator - 403 Forbidden
                response.statusCode = 403;
                request.statusCodeMessage = "Forbidden";
      ...
      case "/admin/gamification-events/export": {
        if (cookies.authToken != null) {
          ...
          return dataController.handleExportGamificationEventsRequest(
            request,
            response
          );
        }
      ...
      default: {
        ...
        if (url.startsWith("/profile/view_gamification_system")) {
          if (cookies.authToken != null) {
            return gamificationSystemController.handleViewGamificationSystemRequest(
              request,
              response,
              "/profile/view_gamification_system"
            );
          }
        ...
        if (url.startsWith("/profile/modify_gamification_system")) {
          if (cookies.authToken != null) {
            return gamificationSystemController.handleViewGamificationSystemRequest(
              request,
              response,
              "/profile/modify_gamification_system"
            );
          }
        ...
        if (url.startsWith("/profile/delete_gamification_system")) {
          if (cookies.authToken != null) {
            return gamificationSystemController.handleViewGamificationSystemRequest(
              request,
              response,
              "/profile/delete_gamification_system"
            );
          }
        ...
        if (url.startsWith("/external/gamification_system/top_users")) {
          return gamificationSystemExternalController.handleExternalGamificationSystemTopUsersGETRequest(
            request,
            response
          );
        }
        ...
        if (url.startsWith("/external/gamification_system")) {
          return gamificationSystemExternalController.handleExternalGamificationSystemGETRequest(
            request,
            response
          );
        }
        ...
        request.errorMessage =
          "Nu am găsit pagina pe care încerci sa o accesezi!";
        return errorRoute(request, response);
      }
    }
  else {
    ...
    request.statusCodeMessage = "Forbidden";
    request.errorMessage =
      'Nu poți face un request de tip GET la pagina "' + url + '"!';
    response.setHeader("Location", "/error");
    return errorRoute(request, response);
  }
};
